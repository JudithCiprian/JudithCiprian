...
int main(void) {
    ...
    puts(a2.carrera);
    printf("%.2f\n", a2.promedio);
    puts(a2.personales.correo); // Imprime el correo electrónico
    ...
    puts(a2.personales.celular); // Imprime el teléfono celular
    ...
    puts(a3.carrera);
    printf("%.2f\n", a3.promedio);
    puts(a3.personales.celular); // Imprime el teléfono celular
}
