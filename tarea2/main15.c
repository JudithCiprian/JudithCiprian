#include <stdio.h>
#include <stdlib.h>
//SPA, programa al recibir como datos el tipo de tratamiento, la edad y el numero de dias de internacion de un cliente en un spa, clacula el costo total del tratamiento
