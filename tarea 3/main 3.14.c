...
//eleccion, el programa obtiene el total de votos de cada candidato y el porcentaje correspondiente. tambien correspondiente y considerando votos nulos
//VOT, C1, C2, C3, C4, C5, NU,SVO: variable de tipo entero
//PO1, PO2, PO3, PO4, PO5, PON: variable de tipo entero
int main()
{
 int VOT, C1 = 0, C2 = 0, C3 = 0, C4 = 0, C5 = 0, NUM = 0, SVO;
 ...
 while (VOT)
 {
     ...
     printf("\n\nCandidato 1: %d votos -- Porcentaje: %5.2f", NU, PON;
